    ...
    <div className="flex items-center justify-between">
      <div className="flex items-center justify-start rtl:justify-end">
        ...
        <a href="/" className="flex ms-2 md:me-24">
          <img src="https://img.freepik.com/free-vector/head-with-ai-chip_78370-3672.jpg" className="h-8 me-3" alt="Logo" />
          <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap">Logo</span>
        </a>
      </div>
      ...
      <ul className="space-y-2 font-medium">
         ...
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
               ...
               <span className="flex-1 ms-3 whitespace-nowrap">Prompt</span>
         ...
         <li>
            <button onClick={logout} className="flex items-center p-2 fixed bottom-10 text-gray-900 rounded-lg hover:bg-gray-100 group">
